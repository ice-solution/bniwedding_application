...
const BANNER_URL = "https://private-us-east-1.manuscdn.com/sessionFile/SCLqXJNivH4yF4OjBeLw6T/sandbox/GqPFXedeHDf8BCu5jDsRD9-img-1_1770750950000_na1fn_Ym5pLWJud2ctYmFubmVy.png?x-oss-process=image/resize,w_1920,h_1920/format,webp/quality,q_80&Expires=1798761600&Policy=eyJTdGF0ZW1lbnQiOlt7IlJlc291cmNlIjoiaHR0cHM6Ly9wcml2YXRlLXVzLWVhc3QtMS5tYW51c2Nkbi5jb20vc2Vzc2lvbkZpbGUvU0NMcVhKTml2SDR5RjRPakJlTHc2VC9zYW5kYm94L0dxUEZYZWRlSERmOEJDdTVqRHNSRDktaW1nLTFfMTc3MDc1MDk1MDAwMF9uYTFmbl9ZbTVwTFdKdWQyY3RZbUZ1Ym1WeS5wbmc~eC1vc3MtcHJvY2Vzcz1pbWFnZS9yZXNpemUsd18xOTIwLGhfMTkyMC9mb3JtYXQsd2VicC9xdWFsaXR5LHFfODAiLCJDb25kaXRpb24iOnsiRGF0ZUxlc3NUaGFuIjp7IkFXUzpFcG9jaFRpbWUiOjE3OTg3NjE2MDB9fX1dfQ__&Key-Pair-Id=K2HSFNDJXOU9YS&Signature=d6zMGk2O4ahYH0BihJalI8OetH6Im6a2ILNLTx6ZawqmnfSaOLVQA~vI50AMNOOT6ZLtqLnEu6QbG7LQ5Zt7EJYr79n8gxl524bX1V54pujuEOcQCMT4Gxv6YwLyzSOjkfELlR8fAH6Lob1cH11pbVnXq7W-li0T6DG54yVzyffccGPEoDZ-RcQiabn-3EcB1veBGK~KcYiimyH9vzmku4G2iiKgMzJR18ySnvrwDSzFzd83zl-OktWJ~bKG5-4lM-rCU8fb1S1bis1Q8ytrDhxMBA5CreDD~4CuZ8cNxXFRWJYfC7MDbiuDcBc4tBvRpcyA0dN0-JOJui1sxfHVTg__";
...
export default function MemberForm() {
  ...
  const submitMutation = trpc.members.submit.useMutation({
    onSuccess: () => {
      toast.success("提交成功！", {
        description: "您的會員資訊已成功提交，我們會盡快審核。",
      });
      reset();
      setUploadedFiles([]);
    },
